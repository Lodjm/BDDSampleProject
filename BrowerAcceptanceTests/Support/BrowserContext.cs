...
namespace BrowerAcceptanceTests.Support
{
    public class BrowserContext : IDisposable
    {
        ...
        public BrowserContext(BrowserFactory browserFactory, ScenarioContext scenarioContext)
        {
        ...
        {
            Driver.Navigate().GoToUrl(new Uri(relativeUrl));
        ...
        public void AssertOnPath(string relativeUrl)
        {
            ...
            {
                var expectedUrl = new Uri(relativeUrl).GetLeftPart(UriPartial.Path);
